function [dv] = completeInterplanetaryGA(t1, t2, t3, code1, code2, code3)

% Function for interplanetary dv calculator - optimization only (GA)
%
% Usage
% [dv] = completeInterplanetaryGA(t1, t2, t3, code1, code2, code3)
%
% Input arguments:
% ----------------------------------------------------------------
