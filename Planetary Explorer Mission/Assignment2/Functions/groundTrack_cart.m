function [alpha, delta, lon, lat] = groundTrack_cart(y0, t_vect, mu_E, theta0_g, om_E)

% alpha, delta, lon and lat calculator
%
% usage:
% [alpha, delta, lon, lat] = groundTrack_cart(y0, t_vect, mu_E, theta0_g, om_E)
%
% Input arguments:
% ----------------------------------------------------------------
% y0            [6x1]       y0 = [r0'; v0']                 [-]
