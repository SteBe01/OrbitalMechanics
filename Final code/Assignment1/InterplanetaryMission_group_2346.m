%% InterplanetaryMission_group_2346
...
% Use the scrpit "contourPlots_and_synodic.m" (located inside the folder
% "Function") to generate the contour plots and the data relative to the
% synodic period
